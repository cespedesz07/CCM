...
import com.example.ccm.eventos.ItemEventoAdapter;
 ...
 *
 */
public class EventosRestClientTask extends AsyncTask< String, Integer, ArrayList<Object[]> > {
	
	
	//URL que conecta a los datos de eventos y ubicaciones
	private static final String URL_EVENTOS_UBICACION_READ = "http://192.168.173.1/Yii_CCM_WebService/web/index.php/rest/evento/sql";
	...
	public EventosRestClientTask( Context context, ListView listaEventos ) {
	...
	public ArrayList<Object[]> procesarJSONArray( JSONArray jsonArray ){
		...
		for ( int i=0; i<numJSONObjects; i++ ){
			try{
				...
				Evento evento = new Evento(idEvento, nombreEvento, descripcionEvento);
